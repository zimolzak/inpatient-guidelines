...
Medical School.\footnote{doing analysis of insurance claims to predict
adherence to statins.} I worked at VA Boston from 2014 to 2018, doing
\emph{clinical research informatics,} which means ``using clinical and
data warehouse expertise to make VA data usable for
research.''\footnote{Example projects: (1) Lung cancer genotyping and
phenotyping to develop a learning healthcare system. (2) A randomized
trial of HCTZ versus chlorthalidone, ``embedded'' in the point of
care. (3) Natural language processing of serum protein electrophoresis
reports. (4) Machine learning to help lab result data cleaning across
the VA nationwide.} I moved to Houston in 2018. My projects here
